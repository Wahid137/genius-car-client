...
const BannerItem = ({ slide }) => {
    ...
    return (
        ...
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 left-24 before: top-1/3">
            ...
            <div className="absolute flex justify-start transform -translate-y-1/2 w-2/5 left-24 top-3/2">
