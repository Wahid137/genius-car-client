...
const BannerItem = ({ slide }) => {
    ...
    return (
        ...
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 left-24 before: top-1/4">
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 w-2/5 left-24 top-96">
                <p className='text-xl sm: text-white lg: text-yellow-500'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
            </div>
