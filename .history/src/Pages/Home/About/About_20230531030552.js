...
const About = () => {
    return (
        <div className="hero my-20">
            <div className="ms-0 ps-0 hero-content flex-col lg:flex-row">
                <div className='relative w-1/2'>
                    <img src={person} alt="person" className="w-3/4 rounded-lg shadow-2xl" />
                    <img src={parts} alt="parts" className="absolute right-16 w-3/5 top-1/2 max-w-sm rounded-lg shadow-2xl" />
                </div>
                <div className='w-1/2'>
