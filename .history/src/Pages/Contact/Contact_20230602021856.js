...
import { FaCalendarDay, FaLocationArrow, FaPhone, FaPhoneAlt, FaSearchLocation } from 'react-icons/fa';
            ...
            <div className="card-body">
                <div class="flex justify-around">
                    <div className='flex items-center'>
                        <FaCalendarDay className='me-5  w-8 h-8 text-red-400' />
                        <div>
                    ...
                    <div className='flex items-center'>
                        <FaPhoneAlt className='me-5 text-red-400  w-8 h-8' />
                        <div>
                    ...
                    <div className='flex items-center'>
                        <FaLocationArrow className='me-5  w-8 h-8 text-red-400' />
                        <div>
