...
const ProductCard = ({ product }) => {
    ...
    return (
        <div className="w-80 h-96 relative card card-compact bg-base-100 shadow-xl">
            <figure><img className="rounded-sm w-44 h-36 p-5 bg-[#d4d4d8]" src={img} alt="product" /></figure>
