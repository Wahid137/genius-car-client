        ...
        <div className="w-[364px] h-[487px] card card-compact bg-base-100 shadow-xl">
            ...
            <div className="card-body text-center mb-5">
                ...
                <div className='flex justify-center pb-3'>
                    <FaFacebook className='w-10 h-10 me-2 text-blue-[#395185]'></FaFacebook>
                    <FaTwitter className='w-10 h-10 me-2'></FaTwitter>
                    <FaLinkedin className='w-10 h-10 me-2'></FaLinkedin>
