        ...
        <div className="w-[364px] h-[487px] card card-compact bg-base-100 shadow-xl">
            ...
            <div className="card-body text-center mb-5">
                ...
                <div className='flex justify-center pb-3'>
                    <FaFacebook className='w-10 h-10 me-2 text-[#395185] bg-red-400 rounded-full'></FaFacebook>
                    <FaTwitter className='rounded-full w-10 h-10 me-2 border bg-[#55ACEE] text-white'></FaTwitter>
