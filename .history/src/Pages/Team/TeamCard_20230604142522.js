        ...
        <div className="w-[364px] h-[487px] card card-compact bg-base-100 shadow-xl">
            ...
            <div className="card-body text-center mb-5">
                ...
                <div className='flex justify-center pb-3'>
                    ...
                    <FaLinkedinIn className='w-10 h-10 me-2 rounded-full text-white text-sm bg-[#0A66C2]'></FaLinkedinIn>
                    <FaInstagram className='w-10 h-10 me-2 bg-orange-600 text-white rounded-full p-2'></FaInstagram>
                </div>
            </div>
        </div >
    );
